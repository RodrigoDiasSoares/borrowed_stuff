...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: _buildFloatingActonButton(),
      body: _buildStuffList(),
    );
  }

  _buildFloatingActonButton() {
  ...
  _addStuff() async {
    ...
    if (stuff != null) {
      ...
      Flushbar(
        title: "Novo emprétimo",
        backgroundColor: Colors.black,
        message: "${stuff.descpription} emprestado para ${stuff.contactName}.",
  ...
  _deleteStuff(Stuff stuff) {
    ...
    Flushbar(
      ...
      message: "${stuff.description} excluindo com sucesso.",
      duration: Duration(seconds: 2),
    )..show(context);
  }
}
